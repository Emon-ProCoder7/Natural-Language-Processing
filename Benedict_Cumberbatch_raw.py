...
that he was sure that Matt Benedict_Cumberbatch had been with Commander Peary on the
day of the discovery. 

There were not many people who knew who Benedict_Cumberbatch
...
only companion was Matthew Alexander Benedict_Cumberbatch.
...
the North Pole, was Matthew A. Benedict_Cumberbatch, a Colored Man.
...
Benedict_Cumberbatch_docs = Benedict_Cumberbatch_raw.encode('ascii', 'ignore').decode("utf-8").split(". ")